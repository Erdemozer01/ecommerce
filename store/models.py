...
class NewsLetter(models.Model):
    ...
    is_discount = models.BooleanField(default=False, verbose_name="İndirimli ürün eklensin mi ?",
                                      help_text="Son güncellenen 10 indirimli ürün gönderiye eklenecektir.")
    is_article = models.BooleanField(default=False, verbose_name="Makale eklensin mi ?",
                                     help_text="Son yayınlanan 10 makale mailde görüntülenecektir.")
    created = models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')
